    ...
    return (
        <div className="relative h-screen">
            ...
            <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center text-center">
                ...
                <button className="text-base md:text-lg lg:text-xl text-white bg-rose-500 hover:bg-rose-600 py-2 px-4 rounded-3xl mt-4 font-medium" onClick={goToSignUp}>Get started</button>
            </div>
        </div>
    );
}
